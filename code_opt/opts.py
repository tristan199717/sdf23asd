...
def parse_opt():
    ...
    parser.add_argument('--new_dataset_name', type=str, default='grad_576_frogs178_1to0', help='name of new generated poisoned dataset.')
    ...
    parser.add_argument('--attack_method', type=str, default='frogs', help='the method of attacking each sample in the inner loop (atonce / fsgs/ ompgs / gradattack)')
    
    parser.add_argument('--base_class_id', type=int, default=0, help='The label of samples allowed to change')
    ...
    parser.add_argument('--base_top_num', type=int, default=576, help='The number of base samples')
    parser.add_argument('--num_changes_stepbystep', type=int, default=1, help='The number of allowed changes step by step.') #30
    parser.add_argument('--dataset_craft', type=str, default='aggregate', help='aggregate: add poison into clean dataset aggregately \
    ...
    parser.add_argument('--base_sample_choice', type=str, default='baseline', help='align: use alignment score from embedding space of input data\
                        baseline / jac_dist / dist / logit / random: use logit from model / influence: use influence score from embedding space of input data')

    #training parameters
    parser.add_argument('--num_epochs', type=int, default=15) #30
    parser.add_argument('--batch_size', type=int, default=64, help='batch size') #8 (EHR) / 32 (others)
